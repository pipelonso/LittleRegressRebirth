...
#Animation pee time
scoreboard objectives add lrpeeanimtime dummy
#Animation pee control
scoreboard objectives add lrpeeanimplay dummy
# este score evalua que solo se ejecuten algunas cosas una sola vez
scoreboard objectives add lrpeeanimupdate dummy
#Time to go to poo
